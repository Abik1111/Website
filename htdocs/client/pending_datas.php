<?php
	...
	$current_page = 1;
	$total_page = 1;
	$selector = new JaggaRequestSelect($_SESSION['host'],$_SESSION['client_username'],$_SESSION['client_password']);
	$searching = false;
	$results = 0;
...
<body class="container">
	...
	<?php endif;?><br/>
	<div class="label">Pending properties</div>
	<?php if(sizeof($data)==0):?>
		<div class="check center">All Datas Checked</div>
	<?php else: ?>
