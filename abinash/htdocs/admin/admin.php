		...
		<?php else: ?>
			<div>
				...
				<?php foreach ($datas as $data):?>
					<li class="list">
						<img src="<?php $data->echoCoverSrc();?>" class="listImage">
						<a href="?dataID=<?php $data->echoId();?>" class="list-text"></br>
							Location: <?php $data->echoLocation()?></br>
							Area: <?php $data->echoArea();?> sq.m</br>
							Price: Rs. <?php JaggaBlock::echoMoneyFormat($data->getPrice());?>/-
						</a>
					</li>
				<?php endforeach; ?>
				</ul>
